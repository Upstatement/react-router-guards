...
import { GuardFunction, GuardProvider, GuardedRoute } from 'react-router-guards';
    ...
    <div className={styles.container}>
      ...
      <div className={styles.main}>
        ...
        <div className={styles.content}>
          <GuardProvider ignoreGlobal guards={[waitOneSecond]}>
            <Switch>
              ...
              <GuardedRoute path={`${path}/stats`} exact>
